...
const confirmingPayoutDeletion = ref(false);
...
const confirmUserDeletion = () => {
    confirmingPayoutDeletion.value = true;

};

const deletePayout = () => {
    form.delete(route('payouts.destroy',data.payout), {
        preserveScroll: true,
...
const closeModal = () => {
    confirmingPayoutDeletion.value = false;
...
<template>
    <section class="space-y-6">
        ...
        <Modal :show="confirmingPayoutDeletion" @close="closeModal">
            <div class="p-6">
