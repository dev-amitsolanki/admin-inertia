...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-indigo-600 leading-tight mb-5">Create Invoice</h2>
            <div class="container">
                <div class="p-6 bg-white shadow sm:rounded-lg">
                    <form @submit.prevent="submitForm">
                        <Transition
                            ...
                            >
                            <p v-if="form.recentlySuccessful" class="text-sm bg-green-200 px-4 rounded-md  py-2 text-green-900">Invoice Created Successfully.</p>
                        </Transition>
